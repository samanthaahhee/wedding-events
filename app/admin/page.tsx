...
export default async function AdminDashboard() {
  ...
  const tableRows: ResponseSummaryRow[] = all.map((r) => ({
    ...
    full: {
      ...
      tools_communication_other: r.toolsCommunicationOther,
      tools_calendar: r.toolsCalendar,
      tools_calendar_other: r.toolsCalendarOther,
      tools_documents: r.toolsDocuments,
      tools_documents_other: r.toolsDocumentsOther,
      ...
      soft_hold_duration: r.softHoldDuration,
      soft_hold_duration_other: r.softHoldDurationOther,
